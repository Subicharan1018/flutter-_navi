...
## Corpus Check
- 165 files · ~271,239 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1677 nodes · 3058 edges · 120 communities (112 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c1dde7d6`
...
5. `../../models/song.dart` - 47 edges
6. `../../../core/theme.dart` - 45 edges
7. `listening_stats_screen.dart` - 44 edges
8. `../../providers/settings_provider.dart` - 43 edges
9. `subsonic_service.dart` - 42 edges
...
Cohesion: 0.06
Nodes (61): ../core/palette_cache.dart, dart:math, _AppleMusicThumb, _AudioQualityStrip, _BottomAction, build, Center, Container (+53 more)

### Community 1 - "../features/ai_shuffle/ui/ai_shuffle_screen.dart / ShuffleStatsResponse / AlbumStat"
Cohesion: 0.07
Nodes (44): ../core/app_exception.dart, AppException, AuthException, NetworkException, ServerException, SubsonicApiException, TimeoutException, toString (+36 more)
...
Cohesion: 0.05
Nodes (41): ArtistAffinityCompanion, ArtistAffinityEntity, copyWith, copyWithCompanion, Function, GenreAffinityCompanion, GenreAffinityEntity, map (+33 more)

### Community 4 - "../../data/models/health_response.dart / AiShuffleScreen / _AiShuffleScreenState"
Cohesion: 0.06
Nodes (42): ../features/ai_shuffle/ui/home_stats_widget.dart, AnimatedOpacity, _artGradient, build, cardBg, Container, dispose, _EmptyReplayHint (+34 more)

### Community 5 - "../core/app_exception.dart / AppException / AuthException"
Cohesion: 0.07
Nodes (38): _playAll, _AddSongsRow, build, _CircleIconButton, ClipRRect, _CollapsedTitle, _confirmDeletePlaylist, Container (+30 more)

### Community 6 - "CLAUDE.md / 10. Testing Rules / 11. Surprising Connections"
Cohesion: 0.09
Nodes (35): ../../../core/theme.dart, edit_playlist_screen.dart, dispose, initState, build, build, dispose, EditPlaylistScreen (+27 more)

### Community 7 - "favorites_screen.dart / _buildAlbumsGrid / _buildSongsList"
Cohesion: 0.08
Nodes (34): ../core/navigation_transitions.dart, copyWith, dispose, LyricsController, LyricsState, _onPosition, _subscribeToPosition, _AlbumThumb (+26 more)
...
Cohesion: 0.07
Nodes (33): ../controllers/lyrics_controller.dart, GestureDetector, build, _buildBody, _buildError, _buildHeader, _buildShimmer, _buildSyncedList (+25 more)

### Community 10 - "ArtistAffinityCompanion / ArtistAffinityEntity / copyWithCompanion"
Cohesion: 0.09
Nodes (31): add_to_playlist_dialog.dart, Padding, AddToPlaylistDialog, _AddToPlaylistDialogState, BoxConstraints, build, Consumer, Dialog (+23 more)

### Community 11 - "../core/app_constants.dart / applyShuffleAlgorithm / _applySmartLocalAlgorithm"
Cohesion: 0.08
Nodes (32): Playlist, Spacer, _artPlaceholder, build, Container, CustomScrollView, _DailyListeningChart, _DashedLine (+24 more)

### Community 12 - "../controllers/lyrics_controller.dart / initState / _buildBody"
Cohesion: 0.09
Nodes (32): AnimatedBuilder, build, Center, Consumer, Container, dispose, _EmptyConfigState, _ErrorState (+24 more)

### Community 13 - "dart:ffi / AnalyticsStats / _buildCsv"
Cohesion: 0.08
Nodes (28): dart:ffi, AnalyticsStats, _buildCsv, CONFLICT, _csvField, _fileTimestamp, Function, _generateUuid (+20 more)

### Community 14 - "Playlist / CustomScrollView / _DailyListeningChart"
Cohesion: 0.07
Nodes (26): HiveBoxes, _migrateBool, _migrateDouble, _migrateFromSharedPreferences, _migrateInt, _migrateString, _buildTestApp, main (+18 more)

### Community 15 - "add_to_playlist_dialog.dart / ../../../core/theme.dart / edit_playlist_screen.dart"
Cohesion: 0.09
Nodes (26): ControlledAudioPlayer, main, MethodChannel, MockListeningEventCollector, MockPlaylistCacheService, MockSubsonicService, setMockPlaying, setMockPosition (+18 more)
...
Cohesion: 0.08
Nodes (24): dart:async, nowPlaying, ScrobbleService, submit, _fakeSong, ListeningLogService, main, _makeService (+16 more)
...
Cohesion: 0.13
Nodes (23): build, Column, CupertinoActionSheetAction, dispose, DropdownMenuItem, initState, Padding, _SettingsDivider (+15 more)

### Community 21 - "context.md / 🏗️ 1. Core Architecture & Isolate Rules / 🔊 2. Audio Engine & Shuffle Specifications"
Cohesion: 0.08
Nodes (23): addSongsToQueue, build, _buildItem, Center, _confirmDelete, Dismissible, _EmptyLibrary, _FilterChip (+15 more)
...
Cohesion: 0.09
Nodes (22): analog, AnimatedContainer, AppTheme, AppThemeTokens, aura, build, buildTheme, CupertinoClickable (+14 more)
...
Cohesion: 0.12
Nodes (17): ../database/app_database.dart, PlaylistCache, SearchHistory, copyWith, dirHiveKey, fieldHiveKey, LibrarySortPreference, toggleField (+9 more)

### Community 27 - "1.2 Code Quality Non-Negotiables / code:dart (// ❌ NEVER — non-reactive, stale data) / code:dart (// ❌ NEVER in new files)"
Cohesion: 0.15
Nodes (20): ../core/constants.dart, BpmAnalyzerService, CacheSettingsService, copyWith, getString, _normalizedBaseUrl, PlaylistCacheService, ReplayGainService (+12 more)
...
Cohesion: 0.1
Nodes (19): ../features/ai_shuffle/ui/ai_shuffle_screen.dart, Expanded, AppScaffold, _AppScaffoldState, build, Container, didChangeAppLifecycleState, dispose (+11 more)
...
Cohesion: 0.14
Nodes (19): build, Container, dispose, Function, ListTile, _onSearchChanged, Padding, _SearchHeaderDelegate (+11 more)
...
Cohesion: 0.11
Nodes (20): 1.2 Code Quality Non-Negotiables, code:dart (// ❌ NEVER — non-reactive, stale data), code:dart (// ❌ NEVER in new files), code:dart (// ❌ NEVER — mutable model causes unpredictable state bugs), code:dart (// ✅ REQUIRED — immutable with copyWith), code:dart (// ❌ NEVER — these are build failures), code:dart (// ✅ REQUIRED — real implementation or explicit documented s), code:dart (// ❌ NEVER) (+12 more)

### Community 34 - "fl_register_plugins() / generated_plugin_registrant.h / my_application.h"
Cohesion: 0.11
Nodes (14): HealthResponse, _parseInt, _parseInt, ProfileResponse, _parseInt, SessionStatusResponse, _parseInt, ShuffleStatsResponse (+6 more)
...
Cohesion: 0.16
Nodes (14): cache_settings_service.dart, BpmAnalyzerService, _cacheBPM, _estimateBPMFromGenre, _getCachedBPM, getCachedCount, initialize, isCached (+6 more)
...
Cohesion: 0.15
Nodes (12): dart:convert, LyricsResult, LrcLibService, LyricsResult, _cache, LyricsRepository, _structuredLinesToLrc, ReplayUploadService (+4 more)
...
Cohesion: 0.13
Nodes (13): build, Container, QueueScreen, Slidable, build, Dismissible, onSwipeRight, _showFavoriteSnackbar (+5 more)
...
Cohesion: 0.14
Nodes (13): 10. Testing Rules, 11. Surprising Connections, 12. Graph Query Reference, 13. MCP Server, 1. Project Identity, 3. Architecture Overview, 4. God Nodes (Updated), 5. Service Boundaries (Community 61) (+5 more)

### Community 45 - "AppDatabase / MigrationStrategy / app_database.dart"
Cohesion: 0.23
Nodes (11): ../../../../core/hive_boxes.dart, _loadHistory, SearchHistoryNotifier, calculateVolumeMultiplier, getFallbackGain, getMode, getModeDescription, getPreampGain (+3 more)

### Community 46 - "_loadFromHive / getLabel / _initConnectivityWatcher"
Cohesion: 0.15
Nodes (12): download_provider.dart, _compareDatesAsc, compute, Connectivity, LibrarySortNotifier, _persist, _restore, setSort (+4 more)
...
Cohesion: 0.18
Nodes (11): 🔊 Audio Engine Details, code:mermaid (graph TD), code:mermaid (graph LR), code:mermaid (stateDiagram-v2), 🎨 Design System & Aesthetics, 🏗️ High-Level Architecture, Project Architecture: NaviVibe, 🏗️ State Machine (+3 more)

### Community 55 - "MapEntry / addPlay / calculateSongScore"
Cohesion: 0.18
Nodes (11): BUG 4: `applyShuffleAlgorithm` Sets Stale `currentIndex` ✅ (Approved), BUG 5: `_persistState` Timer Fires Multiple Times Per 5s Boundary ✅ (Approved), BUG 6: `PaletteCache` Has No Size Limit ✅ (Approved), BUG 7: Synchronous `File.existsSync()` Per Song on Main Thread ✅ (Approved), Changes From Previous Plan, code:dart (import 'dart:collection';), code:dart (// BEFORE (stale):), code:dart (// New field) (+3 more)

### Community 56 - "AppRouteTransitions / buildTransitions / _FadeScaleRoute"
Cohesion: 0.17
Nodes (11): 3. Shader Uniform Layout Reference, 4. Why `shouldRepaint` Returns `true` Every Frame, 5. Impeller vs. Skia Notes, 6. Extending the Shader, 7. Checklist, Adding album art texture warping (closest to real Apple Music), code:glsl (uniform sampler2D u_albumArt;), code:dart (shader.setImageSampler(0, albumArtImage); // ui.Image) (+3 more)
...
Cohesion: 0.31
Nodes (10): ListeningLogService, _QueueEntry, _queueFailedLog, serialize, withIncrementedRetries, listening_log_service.dart, package:http/http.dart, package:shared_preferences/shared_preferences.dart (+2 more)
...
Cohesion: 0.18
Nodes (10): ControlledAudioPlayer, main, MethodChannel, MockAudioHandler, MockClient, MockListeningEventCollector, MockPlaylistCacheService, MockSubsonicService (+2 more)
...
Cohesion: 0.2
Nodes (9): 🤝 Contributing, 🚀 Getting Started, ✨ Key Features, 📄 License, 🎵 Overview, Prerequisites, 📸 Screenshots, code:block1 (Old (_AppleMusicPainter)    New (FluidBackground)) (+1 more)
...
Cohesion: 0.25
Nodes (7): dart:io, MyMusicPlayerApp, OfflineService, ThemeTokens, package:just_audio_background/just_audio_background.dart, package:just_audio_media_kit/just_audio_media_kit.dart, widgets/app_scaffold.dart
...
Cohesion: 0.4
Nodes (4): build, Container, SizedBox, SwipeActionBackground
...
Cohesion: 0.5
Nodes (3): copyWith, SongDownloadState, copyWith
...
Cohesion: 0.67
Nodes (3): Runtime Verification (when Flutter is available), Static Verification, Verification Plan

## Knowledge Gaps
- **926 isolated node(s):** `MainActivity`, `initState`, `dispose`, `build`, `MyMusicPlayerApp` (+921 more)
...
- **Why does `package:flutter_riverpod/flutter_riverpod.dart` connect `CLAUDE.md / 10. Testing Rules / 11. Surprising Connections` to `dart:async / dart:io / ../helpers/test_utils.dart`, `../data/models/profile_response.dart / ../../data/models/recommended_song.dart / ../data/models/session_status_response.dart`, `../../data/models/health_response.dart / AiShuffleScreen / _AiShuffleScreenState`, `../core/app_exception.dart / AppException / AuthException`, `favorites_screen.dart / _buildAlbumsGrid / _buildSongsList`, `analog / AnimatedContainer / AppTheme`, `1.4 Common Flutter Illogical Patterns — Full Reference / Async State Races / Autoplay/Lookahead Guard — Growing Set`, `ArtistAffinityCompanion / ArtistAffinityEntity / copyWithCompanion`, `../core/app_constants.dart / applyShuffleAlgorithm / _applySmartLocalAlgorithm`, `../controllers/lyrics_controller.dart / initState / _buildBody`, `Playlist / CustomScrollView / _DailyListeningChart`, `add_to_playlist_dialog.dart / ../../../core/theme.dart / edit_playlist_screen.dart`, `Spacer / _buildItem / _confirmDelete`, `cancelBackgroundDownload / downloadSongs / File`, `../features/ai_shuffle/ui/home_stats_widget.dart / AnimatedOpacity / _artGradient`, `CupertinoActionSheetAction / DropdownMenuItem / _SettingsDivider`, `context.md / 🏗️ 1. Core Architecture & Isolate Rules / 🔊 2. Audio Engine & Shuffle Specifications`, `../core/constants.dart / ../database/app_database.dart / getString`, `_applyReplayGain / commitSmartLocalOrder / currentQueue`, `1.2 Code Quality Non-Negotiables / code:dart (// ❌ NEVER — non-reactive, stale data) / code:dart (// ❌ NEVER in new files)`, `BUG 5: `_persistState` Timer Fires Multiple Times Per 5s Boundary ✅ (Approved) / BUG 6: `PaletteCache` Has No Size Limit ✅ (Approved) / BUG 7: Synchronous `File.existsSync()` Per Song on Main Thread ✅ (Approved)`, `ClipRRect / CustomPaint / formatDuration`, `code:block16 (User presses Next →) / code:dart (// ❌ ILLOGICAL — does not check if index is still valid afte) / code:dart (// ✅ CORRECT — re-read state after every await)`, `BUG 1: `_trackChangeTimer` Empty Callback ✅ (Approved) / code:dart (_trackChangeTimer = Timer(const Duration(milliseconds: 200),) / BUG-001: `_trackChangeTimer` Missing Mounted/Dispose Guard`, `SliverToBoxAdapter / SliverPadding / _NewReleaseCard`, `NaviVibe Architecture & Security Audit Report / Section 10: What Is Done Well / Section 1: Executive Summary`, `1. File Changes / code:yaml (flutter:) / code:dart (class _AppleMusicPainter extends CustomPainter { … })`, `AppDatabase / MigrationStrategy / app_database.dart`, `_loadFromHive / getLabel / _initConnectivityWatcher`, `AS / CAST / _queryReplay`, `3. Shader Uniform Layout Reference / 4. Why `shouldRepaint` Returns `true` Every Frame / 5. Impeller vs. Skia Notes`, `toString / getCurrentLineIndex / LyricLine`, `G_DECLARE_DERIVABLE_TYPE() / fl_message_codec.h / fl_method_codec.h`, `AudioHandler Performance / [MODIFY] [audio_handler.dart](file:///d:/Subi_project/flutter-_navi/lib/services/audio_handler.dart) / [MODIFY] [palette_cache.dart](file:///d:/Subi_project/flutter-_navi/lib/core/palette_cache.dart)`, `_cacheSongs / PlaylistController / compute`, `isLrcFormat / LrcParser / parseLrc`, `6. Extending the Shader / Adding album art texture warping (closest to real Apple Music) / code:glsl (uniform sampler2D u_albumArt;)`, `PlaylistCache / SearchHistory / playlist_cache_table.dart`, `dart:ui / DecoratedBox / Stack`, `code:dart (// ❌ NEVER — mutable model causes unpredictable state bugs) / code:dart (// ✅ REQUIRED — immutable with copyWith) / Immutable Models`, `fl_method_call.h`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Why does `package:flutter/material.dart` connect `1.4 Common Flutter Illogical Patterns — Full Reference / Async State Races / Autoplay/Lookahead Guard — Growing Set` to `dart:async / dart:io / ../helpers/test_utils.dart`, `../../data/models/health_response.dart / AiShuffleScreen / _AiShuffleScreenState`, `../core/app_exception.dart / AppException / AuthException`, `CLAUDE.md / 10. Testing Rules / 11. Surprising Connections`, `favorites_screen.dart / _buildAlbumsGrid / _buildSongsList`, `ArtistAffinityCompanion / ArtistAffinityEntity / copyWithCompanion`, `../core/app_constants.dart / applyShuffleAlgorithm / _applySmartLocalAlgorithm`, `../controllers/lyrics_controller.dart / initState / _buildBody`, `Playlist / CustomScrollView / _DailyListeningChart`, `Spacer / _buildItem / _confirmDelete`, `CupertinoActionSheetAction / DropdownMenuItem / _SettingsDivider`, `context.md / 🏗️ 1. Core Architecture & Isolate Rules / 🔊 2. Audio Engine & Shuffle Specifications`, `../core/navigation_transitions.dart / _AlbumThumb / didChangeDependencies`, `BUG 5: `_persistState` Timer Fires Multiple Times Per 5s Boundary ✅ (Approved) / BUG 6: `PaletteCache` Has No Size Limit ✅ (Approved) / BUG 7: Synchronous `File.existsSync()` Per Song on Main Thread ✅ (Approved)`, `ClipRRect / CustomPaint / formatDuration`, `code:block16 (User presses Next →) / code:dart (// ❌ ILLOGICAL — does not check if index is still valid afte) / code:dart (// ✅ CORRECT — re-read state after every await)`, `1.1 Before Writing Any Code / 1.3 The Music Player Logic Test — Spot Every Illogical Behaviour / code:block1 (BUILD → SELF-AUDIT → TEST)`, `BUG 1: `_trackChangeTimer` Empty Callback ✅ (Approved) / code:dart (_trackChangeTimer = Timer(const Duration(milliseconds: 200),) / BUG-001: `_trackChangeTimer` Missing Mounted/Dispose Guard`, `1. CODE QUALITY / 2. ARCHITECTURE & DESIGN / 3. PERFORMANCE`, `LyricsState / _subscribeToPosition / SongDownloadState`, `NaviVibe Architecture & Security Audit Report / Section 10: What Is Done Well / Section 1: Executive Summary`, `1. File Changes / code:yaml (flutter:) / code:dart (class _AppleMusicPainter extends CustomPainter { … })`, `AS / CAST / _queryReplay`, `3. Shader Uniform Layout Reference / 4. Why `shouldRepaint` Returns `true` Every Frame / 5. Impeller vs. Skia Notes`, `toString / getCurrentLineIndex / LyricLine`, `G_DECLARE_DERIVABLE_TYPE() / fl_message_codec.h / fl_method_codec.h`, `code:dart (// Required: a regression test that reproduces the exact bug) / Minimum Test Coverage Per Task / Phase 3: TEST — Mandatory Test Plan Per Task`, `BUG 2: `_playedDuration` Drift & Scrobble Logic ⚠️ (Reworked) / code:dart (Duration _accumulatedListenTime = Duration.zero;  // replace) / code:dart (player.playingStream.listen((playing) {)`, `_cacheSongs / PlaylistController / compute`, `6. Extending the Shader / Adding album art texture warping (closest to real Apple Music) / code:glsl (uniform sampler2D u_albumArt;)`, `query_20260513_054343_song_model_dependencies_that_cross_layer_boundarie.md / query_20260513_054650_playerprovider_listeningeventcollector_data_flow.md / Q: Song model dependencies that cross layer boundaries`, `PlaylistCache / SearchHistory / playlist_cache_table.dart`, `1. Presentation Layer (`lib/screens`, `lib/widgets`) / 2. State Management Layer (`lib/providers`) / 3. Service Layer (`lib/services`)`, `code:dart (// ❌ NEVER — mutable model causes unpredictable state bugs) / code:dart (// ✅ REQUIRED — immutable with copyWith) / Immutable Models`, `Constants / constants.dart`, `MainActivity`, `fl_basic_message_channel.h`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `../../models/song.dart` connect `ArtistAffinityCompanion / ArtistAffinityEntity / copyWithCompanion` to `dart:async / dart:io / ../helpers/test_utils.dart`, `../features/ai_shuffle/ui/ai_shuffle_screen.dart / ShuffleStatsResponse / AlbumStat`, `../../data/models/health_response.dart / AiShuffleScreen / _AiShuffleScreenState`, `../core/app_exception.dart / AppException / AuthException`, `CLAUDE.md / 10. Testing Rules / 11. Surprising Connections`, `favorites_screen.dart / _buildAlbumsGrid / _buildSongsList`, `analog / AnimatedContainer / AppTheme`, `1.4 Common Flutter Illogical Patterns — Full Reference / Async State Races / Autoplay/Lookahead Guard — Growing Set`, `../core/app_constants.dart / applyShuffleAlgorithm / _applySmartLocalAlgorithm`, `dart:ffi / AnalyticsStats / _buildCsv`, `Spacer / _buildItem / _confirmDelete`, `cancelBackgroundDownload / downloadSongs / File`, `../features/ai_shuffle/ui/home_stats_widget.dart / AnimatedOpacity / _artGradient`, `context.md / 🏗️ 1. Core Architecture & Isolate Rules / 🔊 2. Audio Engine & Shuffle Specifications`, `dart:convert / _cache / _structuredLinesToLrc`, `Function / _buildSectionTitle / _buildTable`, `_applyReplayGain / commitSmartLocalOrder / currentQueue`, `BUG 5: `_persistState` Timer Fires Multiple Times Per 5s Boundary ✅ (Approved) / BUG 6: `PaletteCache` Has No Size Limit ✅ (Approved) / BUG 7: Synchronous `File.existsSync()` Per Song on Main Thread ✅ (Approved)`, `BUG 1: `_trackChangeTimer` Empty Callback ✅ (Approved) / code:dart (_trackChangeTimer = Timer(const Duration(milliseconds: 200),) / BUG-001: `_trackChangeTimer` Missing Mounted/Dispose Guard`, `cache_settings_service.dart / ../../../../core/hive_boxes.dart / _loadHistory`, `dart:math / _QueueEntry / _queueFailedLog`, `SliverToBoxAdapter / SliverPadding / _NewReleaseCard`, `NaviVibe Architecture & Security Audit Report / Section 10: What Is Done Well / Section 1: Executive Summary`, `1. File Changes / code:yaml (flutter:) / code:dart (class _AppleMusicPainter extends CustomPainter { … })`, `_loadFromHive / getLabel / _initConnectivityWatcher`, `toString / getCurrentLineIndex / LyricLine`, `AudioHandler Performance / [MODIFY] [audio_handler.dart](file:///d:/Subi_project/flutter-_navi/lib/services/audio_handler.dart) / [MODIFY] [palette_cache.dart](file:///d:/Subi_project/flutter-_navi/lib/core/palette_cache.dart)`, `G_DECLARE_INTERFACE() / fl_plugin_registry.h / fl_texture.h`, `Constants / constants.dart`?**
