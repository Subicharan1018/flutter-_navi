...
## Corpus Check
- 164 files · ~273,080 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1598 nodes · 2823 edges · 110 communities (101 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `33bc8681`
...
Cohesion: 0.06
Nodes (45): ../core/navigation_transitions.dart, ../features/ai_shuffle/ui/ai_shuffle_screen.dart, Expanded, AppScaffold, _AppScaffoldState, build, didChangeAppLifecycleState, dispose (+37 more)
...
Cohesion: 0.08
Nodes (34): DownloadStateNotifier, OfflineService, _performDownload, progressOf, _set, _setFailed, statusOf, _buildContainer (+26 more)
...
Cohesion: 0.1
Nodes (30): build, build, Container, QueueScreen, Slidable, nowPlaying, ScrobbleService, submit (+22 more)

### Community 10 - "Playlist Header Widgets"
Cohesion: 0.09
Nodes (33): AnimatedBuilder, build, Center, Consumer, Container, dispose, _EmptyConfigState, _ErrorState (+25 more)
...
Cohesion: 0.09
Nodes (30): ../../../core/theme.dart, edit_playlist_screen.dart, build, dispose, EditPlaylistScreen, _EditPlaylistScreenState, initState, Scaffold (+22 more)
...
Cohesion: 0.11
Nodes (26): SliverToBoxAdapter, _playAll, build, Container, dispose, Function, ListTile, _onSearchChanged (+18 more)
...
Cohesion: 0.08
Nodes (23): analog, AnimatedContainer, AppTheme, AppThemeTokens, aura, build, buildTheme, CupertinoClickable (+15 more)
...
Cohesion: 0.16
Nodes (16): dart:convert, LrcLibService, LyricsResult, _cache, LyricsRepository, _structuredLinesToLrc, ListeningStatsNotifier, PlaylistCacheService (+8 more)

### Community 25 - "Search History Service"
Cohesion: 0.1
Nodes (20): AnalyticsStats, _buildCsv, CONFLICT, _csvField, _fileTimestamp, Function, _generateUuid, getApplicationDocumentsDirectory (+12 more)
...
Cohesion: 0.1
Nodes (21): 1.4 Common Flutter Illogical Patterns — Full Reference, Autoplay/Lookahead Guard — Growing Set, code:dart (// ❌ ILLOGICAL — no guard), code:dart (// ❌ ILLOGICAL — rebuilds entire widget tree when ANY settin), code:dart (// ❌ ILLOGICAL — timer keeps firing after widget/notifier is), code:dart (// ❌ ILLOGICAL — subscription never cancelled), code:dart (// ❌ ILLOGICAL — crashes when field is absent or wrong type), code:dart (// ❌ ILLOGICAL — classic Flutter error) (+13 more)
...
Cohesion: 0.12
Nodes (16): dart:async, dart:io, MyMusicPlayerApp, OfflineService, ThemeTokens, _fakeSong, ListeningLogService, main (+8 more)
...
Cohesion: 0.17
Nodes (13): ../database/app_database.dart, PlaylistCache, SearchHistory, _cacheSongs, compute, PlaylistController, CachedPlaylistResult, SearchHistoryService (+5 more)

### Community 36 - "App Scaffold & Navigation"
Cohesion: 0.15
Nodes (16): add_to_playlist_dialog.dart, Padding, AddToPlaylistDialog, _AddToPlaylistDialogState, BoxConstraints, build, Consumer, Dialog (+8 more)

### Community 37 - "Core Constants & Exceptions"
Cohesion: 0.13
Nodes (16): GestureDetector, SliverPadding, build, GestureDetector, initState, _NewReleaseCard, NewReleasesScreen, _NewReleasesScreenState (+8 more)
...
Cohesion: 0.19
Nodes (14): dispose, initState, build, Center, dispose, initState, NoLyricsCard, _NoLyricsCardState (+6 more)
...
Cohesion: 0.18
Nodes (10): SafeArea, build, _buildSectionTitle, _buildTable, Padding, SafeArea, SizedBox, SongProfileSheet (+2 more)

### Community 58 - "Analytics Tables"
Cohesion: 0.18
Nodes (10): ControlledAudioPlayer, main, MockListeningEventCollector, MockListeningLogService, MockPlaylistCacheService, MockScrobbleService, MockSubsonicService, setMockPosition (+2 more)
...
Cohesion: 0.22
Nodes (8): dart:ffi, main, makeSong, pumpMicrotasks, package:drift/native.dart, package:navivibe/database/app_database.dart, package:navivibe/services/listening_event_collector.dart, package:sqlite3/open.dart
...
### Community 81 - "Android Main Activity"
Cohesion: 0.67
...
## Knowledge Gaps
- **904 isolated node(s):** `MainActivity`, `initState`, `dispose`, `build`, `MyMusicPlayerApp` (+899 more)
...
- **Why does `package:flutter_riverpod/flutter_riverpod.dart` connect `Listening Stats Screen` to `Now Playing & Queue UI`, `Library & Favorites Screens`, `Home & Made For You Screens`, `Playlist Detail Screen`, `Song Picker Screen`, `Made For You Widgets`, `Playlist Header Widgets`, `Player Provider & Controls`, `Library & Playlist Providers`, `Download Provider & State`, `Search Provider & History`, `Replay Provider`, `Audio Handler & Core Logic`, `Subsonic Service & API`, `Scrobble Service`, `BPM Analyzer Service`, `Replay Gain Service`, `Replay Upload Service`, `Listening Log Service`, `Shuffle Algorithms`, `AI Shuffle Features`, `UI Widgets (Song/Album)`, `App Scaffold & Navigation`, `Core Constants & Exceptions`, `Hive Database & Migration`, `Device Utilities`, `AI Shuffle Data Models`, `AI Shuffle UI Components`, `Replay Screen Tests`, `App Database Schema`, `Listening Stats Models`, `AI Shuffle Repositories`, `Palette Cache Logic`, `Analytics Tables`, `LRC Parser & Lyrics UI`, `Knowledge Graph Rules`, `Subsonic Service Security Audit`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `../../models/song.dart` connect `Scrobble Service` to `Now Playing & Queue UI`, `Replay & New Releases Screens`, `Playlist Detail Screen`, `Song Picker Screen`, `Made For You Widgets`, `Listening Stats Screen`, `Download Provider & State`, `Search Provider & History`, `Replay Provider`, `Subsonic Service & API`, `Playlist Cache Service`, `Listening Event Collector`, `Search History Service`, `BPM Analyzer Service`, `Replay Gain Service`, `Replay Upload Service`, `Shuffle Algorithms`, `UI Widgets (Song/Album)`, `App Scaffold & Navigation`, `Core Themes & Transitions`, `Linux Entry Point`, `AI Shuffle Data Models`, `AI Shuffle UI Components`, `Replay Screen Tests`, `Listening Stats Models`, `Offline Download Logic`, `No Lyrics Card`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `package:flutter/material.dart` connect `Linux Entry Point` to `Now Playing & Queue UI`, `Library & Favorites Screens`, `Song Picker Screen`, `Made For You Widgets`, `Listening Stats Screen`, `Playlist Header Widgets`, `Player Provider & Controls`, `Download Provider & State`, `Search Provider & History`, `Audio Handler & Core Logic`, `Subsonic Service & API`, `Recommendation Service`, `BPM Analyzer Service`, `Transcoding Service`, `Replay Upload Service`, `Shuffle Algorithms`, `AI Shuffle Features`, `App Scaffold & Navigation`, `Core Constants & Exceptions`, `Hive Database & Migration`, `Audio Handler Shuffle Logic`, `Device Utilities`, `Android Entry Point`, `AI Shuffle Data Models`, `App Database Schema`, `Core Utility Tests`, `Architecture Design Context`, `Listening Stats Models`, `AI Shuffle Repositories`, `Palette Cache Logic`, `LRC Parser & Lyrics UI`, `Layered Architecture Rationale`, `Knowledge Graph Rules`, `No Lyrics Card`, `Linux Plugin Registry`?**
