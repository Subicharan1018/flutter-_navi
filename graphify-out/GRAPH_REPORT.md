...
## Corpus Check
- 163 files · ~270,280 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1548 nodes · 2768 edges · 108 communities (99 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f9f92a0a`
...
Cohesion: 0.13
Nodes (20): dart:convert, ../database/app_database.dart, PlaylistCache, SearchHistory, _cacheSongs, compute, PlaylistController, ListeningStatsNotifier (+12 more)
...
Cohesion: 0.13
Nodes (22): AlbumCard, _AlbumPlaceholder, build, Container, Semantics, build, Container, Duration (+14 more)
...
Cohesion: 0.16
Nodes (23): edit_playlist_screen.dart, dispose, initState, build, Center, build, Center, dispose (+15 more)
...
Cohesion: 0.1
Nodes (21): 1.4 Common Flutter Illogical Patterns — Full Reference, Async State Races, Autoplay/Lookahead Guard — Growing Set, code:dart (// ❌ ILLOGICAL — state read before async gap may be stale af), code:dart (// ❌ ILLOGICAL — no guard), code:dart (// ❌ ILLOGICAL — rebuilds entire widget tree when ANY settin), code:dart (// ❌ ILLOGICAL — timer keeps firing after widget/notifier is), code:dart (// ❌ ILLOGICAL — crashes when field is absent or wrong type) (+13 more)
...
Cohesion: 0.15
Nodes (15): isLrcFormat, LrcParser, parseLrc, parsePlain, RegExp, LrcLibService, LyricsResult, _cache (+7 more)
...
Cohesion: 0.25
Nodes (12): dart:async, dart:math, ListeningLogService, _QueueEntry, _queueFailedLog, serialize, withIncrementedRetries, listening_log_service.dart (+4 more)
...
Cohesion: 0.18
Nodes (13): 1.2 Code Quality Non-Negotiables, code:dart (// ❌ NEVER — non-reactive, stale data), code:dart (// ✅ REQUIRED — reactive), code:dart (// ❌ NEVER in new files), code:dart (// ✅ REQUIRED), code:dart (// ❌ NEVER), code:dart (// ✅ REQUIRED), code:dart (// ❌ NEVER — crashes when server returns int instead of doub) (+5 more)
...
Cohesion: 0.29
Nodes (6): build, Container, QueueScreen, Slidable, package:flutter_animate/flutter_animate.dart, package:flutter_slidable/flutter_slidable.dart
...
Cohesion: 0.27
Nodes (6): code:dart (// ❌ NEVER — mutable model causes unpredictable state bugs), code:dart (// ✅ REQUIRED — immutable with copyWith), code:dart (// ❌ NEVER — these are build failures), code:dart (// ✅ REQUIRED — real implementation or explicit documented s), Immutable Models, No Placeholders
...
- **Why does `package:flutter_riverpod/flutter_riverpod.dart` connect `Made For You Playlist Details` to `Replay & New Releases Screens`, `Library & Favorites Screens`, `Home & Made For You Screens`, `Song Picker Screen`, `Settings Screen`, `Listening Stats Screen`, `Player Provider & Controls`, `Library & Playlist Providers`, `Settings Provider`, `Listening Stats Provider`, `Search Provider & History`, `Replay Provider`, `Audio Handler & Core Logic`, `Subsonic Service & API`, `Recommendation Service`, `Playlist Cache Service`, `Listening Event Collector`, `Search History Service`, `Cache Settings Service`, `Replay Gain Service`, `Transcoding Service`, `Replay Upload Service`, `Listening Log Service`, `Shuffle Algorithms`, `AI Shuffle Features`, `App Database (Drift)`, `Palette Cache`, `Device Utilities`, `Android Entry Point`, `AI Shuffle UI Components`, `Replay Screen Tests`, `Event Collector Tests`, `App Database Schema`, `Navigation Animations`, `Core Utility Tests`, `Architecture Design Context`, `Layered Architecture Rationale`, `Knowledge Graph Rules`, `Community 70`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `../../models/song.dart` connect `Search Provider & History` to `Now Playing & Queue UI`, `Replay & New Releases Screens`, `Made For You Detail Screen`, `Song Picker Screen`, `Settings Screen`, `Listening Stats Screen`, `Made For You Playlist Details`, `Library & Playlist Providers`, `Replay Provider`, `Audio Handler & Core Logic`, `Subsonic Service & API`, `Recommendation Service`, `Listening Event Collector`, `Scrobble Service`, `Cache Settings Service`, `Replay Upload Service`, `Listening Log Service`, `Core Constants & Exceptions`, `App Database (Drift)`, `Palette Cache`, `Device Utilities`, `App Database Schema`, `Service Layer Rationale`, `Knowledge Graph Rules`, `Offline Download Logic`, `Subsonic Service Security Audit`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `package:flutter/material.dart` connect `Recommendation Service` to `Replay & New Releases Screens`, `Library & Favorites Screens`, `Song Picker Screen`, `Listening Stats Screen`, `Made For You Playlist Details`, `Library & Playlist Providers`, `Settings Provider`, `Listening Stats Provider`, `Audio Handler & Core Logic`, `Subsonic Service & API`, `Playlist Cache Service`, `Listening Event Collector`, `Cache Settings Service`, `Replay Gain Service`, `Transcoding Service`, `Replay Upload Service`, `Listening Log Service`, `Shuffle Algorithms`, `AI Shuffle Features`, `App Scaffold & Navigation`, `Hive Database & Migration`, `Core Themes & Transitions`, `Palette Cache`, `Android Entry Point`, `Replay Screen Tests`, `Event Collector Tests`, `Core Exception Classes`, `App Database Schema`, `Navigation Animations`, `Core Utility Tests`, `Architecture Design Context`, `Shuffle Logic & Settings`, `Subsonic Service Security Audit`, `Widget Rendering Tests`, `Community 70`, `Community 72`?**
