...
## Corpus Check
- 164 files · ~272,199 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1585 nodes · 2807 edges · 113 communities (105 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a7e99e84`
...
- [[_COMMUNITY_Album Model|Album Model]]
- [[_COMMUNITY_Community 85|Community 85]]
- [[_COMMUNITY_Async State Races Standard|Async State Races Standard]]
- [[_COMMUNITY_Theme Hardcoded Color Standard|Theme Hardcoded Color Standard]]
...
Cohesion: 0.04
Nodes (53): ../core/palette_cache.dart, _AppleMusicThumb, _AudioQualityStrip, _BottomAction, build, Center, Container, Dismissible (+45 more)

### Community 1 - "Replay & New Releases Screens"
Cohesion: 0.06
Nodes (48): ../core/app_exception.dart, AppException, AuthException, NetworkException, ServerException, SubsonicApiException, TimeoutException, toString (+40 more)

### Community 2 - "Library & Favorites Screens"
Cohesion: 0.07
Nodes (41): ControlledAudioPlayer, main, MethodChannel, MockListeningEventCollector, MockPlaylistCacheService, MockSubsonicService, setMockPlaying, setMockPosition (+33 more)
...
Cohesion: 0.08
Nodes (36): ../helpers/test_utils.dart, DownloadStateNotifier, OfflineService, _performDownload, progressOf, _set, _setFailed, statusOf (+28 more)
...
Cohesion: 0.09
Nodes (34): ListeningStatsNotifier, AnimatedBuilder, build, Center, Container, dispose, _EmptyConfigState, _ErrorState (+26 more)

### Community 7 - "Settings Screen"
Cohesion: 0.09
Nodes (32): build, _buildContent, _buildEmptyState, Center, Column, initState, OfflineScreen, _OfflineScreenState (+24 more)

### Community 8 - "Made For You Widgets"
Cohesion: 0.09
Nodes (33): _artPlaceholder, build, Container, CustomScrollView, _DailyListeningChart, _DashedLine, dispose, _EmptyReplay (+25 more)

### Community 9 - "Listening Stats Screen"
Cohesion: 0.07
Nodes (30): ../../../core/theme.dart, build, dispose, EditPlaylistScreen, _EditPlaylistScreenState, initState, Scaffold, build (+22 more)
...
Cohesion: 0.07
Nodes (30): dart:ffi, dart:io, SongPair, AnalyticsStats, _buildCsv, CONFLICT, _csvField, _fileTimestamp (+22 more)
...
Cohesion: 0.11
Nodes (29): edit_playlist_screen.dart, dispose, initState, build, Center, build, Center, dispose (+21 more)
...
Cohesion: 0.08
Nodes (26): 1. Presentation Layer (`lib/screens`, `lib/widgets`), 2. State Management Layer (`lib/providers`), 3. Service Layer (`lib/services`), 4. Data Layer (`lib/database`, `lib/models`), A. Music Playback Flow, 🧠 Advanced Shuffle Algorithms, 🔊 Audio Engine Details, 🔊 Audio Engine & Shuffle Intelligence (+18 more)
...
Cohesion: 0.13
Nodes (22): Positioned, build, Container, dispose, Function, ListTile, _onSearchChanged, Padding (+14 more)

### Community 23 - "Listening Event Collector"
Cohesion: 0.16
Nodes (21): cancelBackgroundDownload, copyWith, downloadSongs, DownloadState, File, formatSize, _getCoverArtPath, getDownloadedCount (+13 more)

### Community 24 - "Scrobble Service"
Cohesion: 0.13
Nodes (18): isLrcFormat, LrcParser, parseLrc, parsePlain, RegExp, LrcLibService, LyricsResult, _cache (+10 more)

### Community 25 - "Search History Service"
Cohesion: 0.13
Nodes (17): Song, _interleave, interleave, MapEntry, songWeight, makeSong, Song, main (+9 more)

### Community 26 - "BPM Analyzer Service"
Cohesion: 0.16
Nodes (19): ../core/constants.dart, BpmAnalyzerService, CacheSettingsService, copyWith, getString, _normalizedBaseUrl, PlaylistCacheService, ReplayGainService (+11 more)
...
Cohesion: 0.14
Nodes (16): dart:convert, MapEntry, CachedPlaylistResult, PlaylistCacheService, addPlay, calculateSongScore, getHourPreference, MapEntry (+8 more)
...
Cohesion: 0.15
Nodes (16): add_to_playlist_dialog.dart, Padding, Consumer, AddToPlaylistDialog, _AddToPlaylistDialogState, BoxConstraints, build, Consumer (+8 more)

### Community 34 - "UI Dialogs"
Cohesion: 0.15
Nodes (15): HealthResponse, ShuffleEmptyResponse, ShuffleRepository, call, NextResponse, ShuffleApiService, _wrap, ../models/health_response.dart (+7 more)
...
Cohesion: 0.13
Nodes (15): GestureDetector, SliverToBoxAdapter, SliverPadding, build, GestureDetector, initState, _NewReleaseCard, NewReleasesScreen (+7 more)

### Community 38 - "Hive Database & Migration"
Cohesion: 0.17
Nodes (12): ../database/app_database.dart, PlaylistCache, SearchHistory, _cacheSongs, compute, PlaylistController, compute, SearchHistoryService (+4 more)
...
Cohesion: 0.23
Nodes (14): 10. Testing Rules, 11. Surprising Connections, 12. Graph Query Reference, 13. MCP Server, 1. Project Identity, 3. Architecture Overview, 4. God Nodes (Updated), 5. Service Boundaries (Community 61) (+6 more)
...
Cohesion: 0.16
Nodes (14): 2. Development Commands, code:bash (flutter pub get), code:bash (flutter pub run build_runner build --delete-conflicting-outp), code:bash (flutter run), code:bash (flutter test), code:bash (flutter test path/to/test_file.dart), code:bash (flutter test path/to/test_file.dart -t "description of test"), code:bash (flutter analyze) (+6 more)
...
Cohesion: 0.15
Nodes (12): ../../data/models/health_response.dart, ../data/models/profile_response.dart, ../data/models/session_status_response.dart, ../data/models/stats_response.dart, ../data/repositories/shuffle_exception.dart, ../data/repositories/shuffle_repository.dart, ../data/services/shuffle_api_service.dart, clearQueue (+4 more)
...
Cohesion: 0.18
Nodes (13): 1.2 Code Quality Non-Negotiables, code:dart (// ❌ NEVER — non-reactive, stale data), code:dart (// ✅ REQUIRED — reactive), code:dart (// ❌ NEVER in new files), code:dart (// ✅ REQUIRED), code:dart (// ❌ NEVER — mutable model causes unpredictable state bugs), code:dart (// ✅ REQUIRED — immutable with copyWith), code:dart (// ❌ NEVER) (+5 more)
...
Cohesion: 0.2
Nodes (9): ShuffleEmptyResponse, ShuffleException, ShuffleNetworkError, ShuffleNotConfigured, ShuffleServerError, toString, ShuffleNetworkError, ShuffleServerError (+1 more)

### Community 63 - "Player Notifier Bug Analysis"
Cohesion: 0.2
Nodes (9): dart:async, _fakeSong, ListeningLogService, main, _makeService, MockHttpClient, _stubPost, _stubPostTimeout (+1 more)
...
Cohesion: 0.25
Nodes (7): HiveBoxes, _migrateBool, _migrateDouble, _migrateFromSharedPreferences, _migrateInt, _migrateString, package:flutter_secure_storage/flutter_secure_storage.dart

### Community 71 - "Audit Checklist"
Cohesion: 0.25
...
Cohesion: 0.25
Nodes (7): 🤝 Contributing, 🚀 Getting Started, ✨ Key Features, 📄 License, 🎵 Overview, Prerequisites, 📸 Screenshots

### Community 76 - "Shader Migration Guide"
Cohesion: 0.29
...
Cohesion: 0.29
Nodes (6): _buildTestApp, main, ProviderScope, package:navivibe/core/theme.dart, package:navivibe/providers/replay_provider.dart, package:navivibe/screens/replay_screen.dart

### Community 78 - "Test Plan & Initialization"
Cohesion: 0.33
Nodes (5): dart:ui, build, DecoratedBox, LyricsBackground, Stack

### Community 79 - "Build Standards"
Cohesion: 0.4
Nodes (4): NextResponse, _parseDouble, RecommendedSong, recommended_song.dart

### Community 80 - "Architecture Action Plan"
Cohesion: 0.33
Nodes (5): AlbumStat, ArtistStat, ListeningStats, RecentPlay, TrackStat

### Community 82 - "App Constants"
Cohesion: 0.33
...
Cohesion: 0.67
Nodes (3): code:dart (// ❌ NEVER — crashes when server returns int instead of doub), code:dart (// ✅ REQUIRED — handles int, double, String-encoded numbers,), No Unsafe Casts

## Knowledge Gaps
- **891 isolated node(s):** `MainActivity`, `initState`, `dispose`, `build`, `MyMusicPlayerApp` (+886 more)
...
- **Why does `package:flutter_riverpod/flutter_riverpod.dart` connect `Song Picker Screen` to `Now Playing & Queue UI`, `Replay & New Releases Screens`, `Library & Favorites Screens`, `Made For You Detail Screen`, `Playlist Detail Screen`, `Settings Screen`, `Made For You Widgets`, `Listening Stats Screen`, `Library & Playlist Providers`, `Settings Provider`, `Download Provider & State`, `Listening Stats Provider`, `Replay Provider`, `Audio Handler & Core Logic`, `Recommendation Service`, `Playlist Cache Service`, `Scrobble Service`, `BPM Analyzer Service`, `Cache Settings Service`, `Replay Gain Service`, `Transcoding Service`, `Replay Upload Service`, `Listening Log Service`, `AI Shuffle Features`, `Core Constants & Exceptions`, `Hive Database & Migration`, `Core Themes & Transitions`, `Linux Entry Point`, `AI Shuffle UI Components`, `Event Collector Tests`, `Navigation Animations`, `Core Utility Tests`, `Architecture Design Context`, `Analytics Tables`, `Service Layer Rationale`, `Layered Architecture Rationale`, `Search State Management`, `Album Art Texture Shader`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `package:flutter/material.dart` connect `Library & Playlist Providers` to `Now Playing & Queue UI`, `Playlist Detail Screen`, `Song Picker Screen`, `Settings Screen`, `Made For You Widgets`, `Listening Stats Screen`, `Settings Provider`, `Download Provider & State`, `Listening Stats Provider`, `Audio Handler & Core Logic`, `Recommendation Service`, `Playlist Cache Service`, `Scrobble Service`, `Cache Settings Service`, `Replay Gain Service`, `Transcoding Service`, `Replay Upload Service`, `AI Shuffle Features`, `App Scaffold & Navigation`, `Core Constants & Exceptions`, `App Database (Drift)`, `Core Themes & Transitions`, `Android Entry Point`, `Core Utility Tests`, `Architecture Design Context`, `Palette Cache Logic`, `Analytics Tables`, `Service Layer Rationale`, `Layered Architecture Rationale`, `Knowledge Graph Rules`, `Graphify Saved Queries`, `Testing Requirements`, `Album Art Texture Shader`, `Test Plan & Initialization`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `../../models/song.dart` connect `Listening Log Service` to `Now Playing & Queue UI`, `Replay & New Releases Screens`, `Made For You Detail Screen`, `Playlist Detail Screen`, `Settings Screen`, `Made For You Widgets`, `Made For You Playlist Details`, `Library & Playlist Providers`, `Settings Provider`, `Replay Provider`, `Audio Handler & Core Logic`, `Playlist Cache Service`, `Listening Event Collector`, `Scrobble Service`, `Search History Service`, `Replay Gain Service`, `Replay Upload Service`, `AI Shuffle Features`, `Hive Database & Migration`, `Device Utilities`, `Linux Entry Point`, `AI Shuffle UI Components`, `Core Utility Tests`, `AI Shuffle Service Logic`, `Graphify Saved Queries`?**
